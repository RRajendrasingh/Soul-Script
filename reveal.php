    ...
    function renderResultPage(data) {
      ...
      `;
        ...
        <div class="fixed inset-0 pointer-events-none overflow-hidden z-0">
          ...
          <!-- Top-Right Mandala -->
          <div class="absolute -top-20 -right-20 w-72 sm:w-96 h-72 sm:h-96 opacity-40 mix-blend-screen">
            <img src="<?php echo APP_URL; ?>/assets/images/gold_mandala_corner.svg" class="w-full h-full rotate-90 animate-spin-slow">
          </div>

          <!-- Middle-Left Side Mandala -->
          <div class="absolute top-1/3 -left-36 w-[450px] sm:w-[550px] opacity-25 mix-blend-screen">
            <img src="<?php echo APP_URL; ?>/assets/images/gold_mandala_side.svg" class="w-full h-full">
          </div>

          <!-- Middle-Right Side Mandala -->
          <div class="absolute top-2/3 -right-36 w-[450px] sm:w-[550px] opacity-25 mix-blend-screen">
            <img src="<?php echo APP_URL; ?>/assets/images/gold_mandala_side.svg" class="w-full h-full">
          </div>

          <!-- Bottom-Left Mandala -->
          <div class="absolute -bottom-24 -left-24 w-80 sm:w-96 h-80 sm:h-96 opacity-35 mix-blend-screen">
            <img src="<?php echo APP_URL; ?>/assets/images/gold_mandala_corner.svg" class="w-full h-full rotate-270">
          </div>

          <!-- Bottom-Right Mandala -->
          <div class="absolute -bottom-24 -right-24 w-80 sm:w-96 h-80 sm:h-96 opacity-35 mix-blend-screen">
            <img src="<?php echo APP_URL; ?>/assets/images/gold_mandala_corner.svg" class="w-full h-full rotate-180">
          </div>
