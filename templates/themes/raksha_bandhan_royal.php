...
<footer class="mt-20 pt-10 pb-16 border-t border-[#4d444b]/40 text-center relative z-10 space-y-5">
  <div class="space-y-1">
    <p class="text-xs text-[#d0c3cb]">Crafted with eternal sibling love by <strong class="text-[#eac34a]"><?= htmlspecialchars($buyerName) ?></strong> for <strong class="text-[#eac34a]"><?= htmlspecialchars($partnerName) ?></strong></p>
    <p class="text-[11px] text-[#80707c]">A magical digital keepsake powered by <span class="text-[#eac34a] font-serif font-bold"><?= defined('APP_NAME') ? APP_NAME : 'GiftReveal' ?></span></p>
  </div>

  <div class="flex flex-wrap items-center justify-center gap-3 pt-2">
    <a href="<?= APP_URL ?>" target="_blank" class="px-5 py-2.5 rounded-full bg-gradient-to-r from-[#eac34a] to-[#d4af37] text-[#241a00] text-xs font-bold uppercase tracking-wider shadow-[0_0_20px_rgba(234,195,74,0.3)] hover:scale-105 transition-all flex items-center gap-2">
